...
<head>
    ...
    <title>Regulation Info Malaysia</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="flag-container">
            <img src="{{ asset('aset/malaysia.png') }}" alt="Singapura Flag" class="country-flag">
        </div>

        <!-- Regulation Links -->
        <div class="regulation-links">
            <a href="{{ asset('files/Regulasi Ekspor-Malaysia.pdf') }}" class="regulation-card">
